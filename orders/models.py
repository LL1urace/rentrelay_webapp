...
class OrderItem(models.Model):
    orders = models.ForeignKey(to=Order, on_delete=models.CASCADE, verbose_name="Заказ")
    ...
    price = models.DecimalField(max_digits=7, decimal_places=7, verbose_name="Цена")
